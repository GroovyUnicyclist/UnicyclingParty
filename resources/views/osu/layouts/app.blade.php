...
<head>
    ...
    <title>{{ config('app.name', 'Unicycle Club') }}</title>
    ...
    <link rel="stylesheet" href="{{ asset('/css/osu.css') }}">
...
<body class="bg-gray">
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark bg-scarlet">
            <div class="container">
                <a class="navbar-brand" href="{{ route('osu') }}">
